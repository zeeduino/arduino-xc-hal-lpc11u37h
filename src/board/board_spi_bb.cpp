...
#define CS_LOW() Chip_GPIO_WritePortBit(LPC_GPIO, CS_PORTv, CS_BITv, false)
#define CS_HIGH() Chip_GPIO_WritePortBit(LPC_GPIO, CS_PORTv, CS_BITv, true)
#define SCK_LOW() Chip_GPIO_WritePortBit(LPC_GPIO, SCK_PORTv, SCK_BITv, false)
#define SCK_HIGH() Chip_GPIO_WritePortBit(LPC_GPIO, SCK_PORTv, SCK_BITv, true)
#define MISO() Chip_GPIO_ReadPortBit(LPC_GPIO, MISO_PORTv, MISO_BITv)
#define MOSI(x) Chip_GPIO_WritePortBit(LPC_GPIO, MOSI_PORTv, MOSI_BITv, x)
